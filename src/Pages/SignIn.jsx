        ...
        <div className="containerBodyConnexion">
          <form onSubmit={handleSubmitSignIn}>
            ...
            <div className="signInFormPassword">
              ...
              <svg className="eyeShowPassword" onClick={handleSeeUnseePassword} height="30px" id="Calque_2" data-name="Calque 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.56 4.63">
                <g id="Calque_1-2" data-name="Calque 1">
                  <g>
                    <path fill="#1d1d1b" class="cls-1" d="m4.56,2.32c0,1.29-1.02,2.31-2.28,2.31-1.28,0-2.21-1.02-2.28-2.16C-.08,1.03,1.07-.01,2.29,0c1.24.01,2.27,1.03,2.27,2.32Zm-4.21,0c0,1.11.88,2.02,2,2,1.06-.02,1.96-.88,1.93-2.06-.02-1.03-.87-1.99-2.07-1.93-.98.04-1.87.86-1.87,2Z"/>
                    <path fill="#1d1d1b" class="cls-1" d="m3.84,2.19c-.02-.3-.13-.59-.32-.83,0,.02,0,.04,0,.06,0,.28-.23.5-.5.5s-.5-.23-.5-.5.21-.49.48-.5c-.21-.11-.45-.17-.72-.18-.85,0-1.59.71-1.56,1.57-.02.87.71,1.56,1.55,1.57.84,0,1.64-.7,1.57-1.69Z"/>
                  </g>
                </g>
              </svg>
            </div>
